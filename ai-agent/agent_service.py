...
class AIAgentService:
    """
    AI Emergency Classifier & Caregiver Assistant Service.
    Classifies incoming emergencies into priority and category, and provides guidance.
    """

    def classify_emergency(self, description: str) -> Dict[str, Any]:
        text = description.lower() if description else ""

        # Category & Priority determination rules
